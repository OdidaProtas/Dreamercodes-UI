    ...
    <>
      <div className="container">
        ...
        <div className="grid-container">
          <div className="daniel grid-item">
            <div className="intro">
              <img  width={60} height={60} src="https://res.cloudinary.com/dreamercodes/image/upload/v1662701235/cld-sample.jpg" alt="" />
              <div className="name">
                <p> Daniel Clifford</p>
          ...
          <div className="jonathan grid-item">
            <div className="intro">
              <img  width={60} height={60} src="https://res.cloudinary.com/dreamercodes/image/upload/v1662701235/cld-sample.jpg" alt="" />
              <div className="name">
          ...
          <div className="patrick grid-item">
            <div className="intro">
              <img  width={60} height={60} src="https://res.cloudinary.com/dreamercodes/image/upload/v1662701235/cld-sample.jpg" alt="" />
              <div className="name">
                <p> Patrick Abrams</p>
